...
export const useColorPicker = () => {
        ...
        // Scene
        let sceneColorPicker = new THREE.Scene();
        ...
        sceneColorPicker.add(vitrailGroup)
        ...
        */
        ...
        sceneColorPicker.add(axesHelper);
        ...
        */
        ...
        sceneColorPicker.add(ambientLight)
        ...
        sceneColorPicker.add(directionalLight)
       ...
       */
        ...
        const tick = () => {
          ...
          // Render
          //renderer.render(sceneColorPicker, camera)
